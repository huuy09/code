...
#################################################New code for FINDER#####################################
    ...
    def Train(self):
        ...
        save_dir = './modelstest/Model_powerlaw'
    ...
    def findModel(self):
        ...
        VCFile = './modelstest/Model_powerlaw/ModelVC_%d_%d.csv'%(NUM_MIN, NUM_MAX)
        vc_list = []
        ...
        best_model = './modelstest/Model_powerlaw/nrange_%d_%d_iter_%d.ckpt' % (NUM_MIN, NUM_MAX, best_model_iter)
        return best_model
